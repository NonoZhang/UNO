...
class Player(object):
    ...
    def find_card(self, deck):
        if self.pre_player.current_play_card is None:
            if self.pre_player.have_play is False:
                player_cu = self.get_available_player(self.pre_player)
                if player_cu is not None:
                    # print player_cu.current_play_card.color, player_cu.current_play_card.property_letter
                    print " check card pre and pre, name is: " + player_cu.name
                    # print player_cu.current_play_card.color, player_cu.current_play_card.property_letter
                    if player_cu.current_play_card.property_letter == "+2":
                        player_cu.current_play_card.property_letter = None
                    elif player_cu.current_play_card.property_letter == "+4":
                        player_cu.current_play_card.property_letter = None
                    # print player_cu.current_play_card.color, player_cu.current_play_card.property_letter
    ...
    def play_card_by_logic(self, card, deck):
            ...
            #     self.current_play_card.color = random.choice(deck.color)
            #     self.current_play_card.property_letter = "change_color"
            #     print "---------change_color-----"
            #     pass
            else:
                ...
                if temp_card_5 is not None:
                    ...
                    self.current_play_card = None
                    # self.current_play_card.color = None
